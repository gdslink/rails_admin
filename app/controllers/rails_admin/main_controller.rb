module RailsAdmin
  class MainController < RailsAdmin::ApplicationController
    ...
    before_action :get_model, except: [:update_scope, :dashboard, :global_search]
    before_action :get_object, only: RailsAdmin::Config::Actions.all(:member).collect(&:action_name)
    before_action :check_scope_on_query, :except => [:index, :update_scope, :dashboard, :global_search, :bulk_action, :bulk_delete, :export]
