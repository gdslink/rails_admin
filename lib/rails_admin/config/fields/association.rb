  ...
  module Config
    module Fields
      class Association < RailsAdmin::Config::Fields::Base
        ...
        def errors
          bindings[:object].errors[child_key] if bindings and bindings.include?(:object) and bindings[:object].respond_to? :errors and bindings[:object].errors.include?(child_key)
        end
